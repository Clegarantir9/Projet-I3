(function($) {
    ...
    $.fn.simpleGauge = function(options) {
        ...
        var defaults = {
			...
			parentBG: '#f0f0f0 ' // This color should match the parent div of the gauge (or beyond)
        };
